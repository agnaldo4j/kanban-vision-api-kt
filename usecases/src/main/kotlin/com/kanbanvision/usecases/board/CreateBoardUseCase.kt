...
class CreateBoardUseCase(
    ...
    suspend fun execute(command: CreateBoardCommand): Either<DomainError, String> =
        either {
            ...
            log.info("Board created: id={} name={} duration={}ms", board.id, command.name, duration.inWholeMilliseconds)
            board.id
        }
}

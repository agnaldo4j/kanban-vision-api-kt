...
- **Quality analysis**: [Wiki — Quality Analysis](https://github.com/agnaldo4j/kanban-vision-api-kt/wiki/Quality-Analysis) — 18-skill scorecard (9.3/10, transparent mean; see `docs/quality/scorecard-2026-07.md`).

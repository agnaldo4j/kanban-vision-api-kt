...
- **Quality analysis**: [Wiki — Quality Analysis](https://github.com/agnaldo4j/kanban-vision-api-kt/wiki/Quality-Analysis) — 22-skill scorecard (9.37/10, transparent mean; see `docs/quality/scorecard-2026-10.md`).

...
|---|---|---|
| **Stability** | Condições dentro de limites conhecidos; o sistema está adaptado | Pipeline verde, cobertura 98%, zero violações Detekt — sistema saudável |
...
- **Safety**: quão fundo pode cair antes de alguém ser punido (build quebra? cobertura cai abaixo de 98%? CI vermelho?)
...
|---|---|---|
| Cobertura JaCoCo | ≥ 98% (gate automático) | CI bloqueia merge se cair |

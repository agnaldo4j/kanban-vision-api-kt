...
dependencies {
    // Flyway 12.x migrou para Jackson 3.x (`tools.jackson`) e puxava a família em 3.1.4 — vulnerável a
    ...
    // aqui (e não só no http_api). Alinha toda a família tools.jackson numa linha.
